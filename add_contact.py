...
class CreateContact(unittest.TestCase):
    ...
    def test_create_new_contact(self):
        ...
        self.info_about_contact(wd, Contact(firstname="joe", middlename="barbaro", address="russia", mobile="nokia",
                                            ...
                                            bday="15", bmonth="May", byear="1996", aday="10", amonth="June", ayear="1991", address_2="world", phone_2="7963852741",
                                            notes="abvgde"))
    ...
    def info_about_contact(self, wd, Contact):
        #add first name
